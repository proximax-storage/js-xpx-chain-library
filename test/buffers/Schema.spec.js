...
import converter from '../../src/coders/convert';
import { array, Schema, table, tableArray, TypeSize, ubyte, uint, ushort } from '../../src/schema/Schema';
...
describe('Schema', () => {
	...
	it('should serialize correctly the FlatBuffers result', () => {
		...
		const resPayload = converter.uint8ToHex(result);
