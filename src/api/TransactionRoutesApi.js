...
export default class TransactionRoutesApi {
    ...
    */
     ...
     * @param {module:model/TransactionPayload} payload The transaction [payload](https://nemtech.github.io/api/serialization.html).
     ...
     * Announces a transaction to the network. It is recommended to use the NEM2-SDK to announce transactions as they should be [serialized](https://nemtech.github.io/api/serialization.html).
     * @param {module:model/TransactionPayload} payload The transaction [payload](https://nemtech.github.io/api/serialization.html).
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Object} and HTTP response
     */
